 ...
 * @author tutu5
 */
public class CuadradoF extends javax.swing.JFrame {

    /**
     * Creates new form CuadradoF
     */
    public CuadradoF() {
        initComponents();
    }
    ...
    public class Cuadrado implements FiguraGeometrica
{
    ...
    private void initComponents() {
        ...
        Lado.setBackground(new java.awt.Color(209, 209, 209));
        Lado.setFont(new java.awt.Font("Agency FB", 0, 24)); // NOI18N
        Lado.setToolTipText("0");
        Lado.setBorder(null);
        Lado.setName("0"); // NOI18N
        Lado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                LadoKeyReleased(evt);
            }
        });
        jPanel2.add(Lado, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 120, 20));
    ...
    private void LadoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LadoKeyReleased

        double a;
        double perimetro;
        double resultado;

        a = doublevalidat(Lado.getText());
    ...
    }//GEN-LAST:event_LadoKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuadradoF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
